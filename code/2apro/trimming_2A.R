...
pep2align <- read_tsv("2A/EntB_2Apro/2Aproclean10.txt", col_names = F)
pep2dms <- read_tsv("2A/DMS_2Apro/2a.txt", col_names = F)

### Assimetrical trimming 

#Alignments
#Right trimming
ali9R<-as.data.frame(gsub(".$","",pep2align$X1))
ali8R<-as.data.frame(gsub("..$","",pep2align$X1))
ali7R<-as.data.frame(gsub("...$","",pep2align$X1))
ali6R<-as.data.frame(gsub("....$","",pep2align$X1))
#Left trimming
ali9L<-as.data.frame(gsub("^.","",pep2align$X1))
ali8L<-as.data.frame(gsub("^..","",pep2align$X1))
ali7L<-as.data.frame(gsub("^...","",pep2align$X1))
ali6L<-as.data.frame(gsub("^....","",pep2align$X1))
...
#DMS
#Right trimming
dms9R<-as.data.frame(gsub(".$","",pep2dms$X1))
dms8R<-as.data.frame(gsub("..$","",pep2dms$X1))
dms7R<-as.data.frame(gsub("...$","",pep2dms$X1))
dms6R<-as.data.frame(gsub("....$","",pep2dms$X1))
#Left trimming
dms9L<-as.data.frame(gsub("^.","",pep2dms$X1))
dms8L<-as.data.frame(gsub("^..","",pep2dms$X1))
dms7L<-as.data.frame(gsub("^...","",pep2dms$X1))
dms6L<-as.data.frame(gsub("^....","",pep2dms$X1))
...
entbic10 <- read_tsv("2A/EntB_2Apro/assimetrical trimming/PSSMSearch_results_2Apro_EntB_10aa.txt")
entbic9R<- read_tsv("2A/EntB_2Apro/assimetrical trimming/PSSMsearch_2apro_9wR_alignments.txt")
entbic9L<-read_tsv("2A/EntB_2Apro/assimetrical trimming/PSSMsearch_2apro_9wL_alignments.txt")
entbic8R<- read_tsv("2A/EntB_2Apro/assimetrical trimming/PSSMsearch_2apro_8wR_alignments.txt")
entbic8L<- read_tsv("2A/EntB_2Apro/assimetrical trimming/PSSMsearch_2apro_8wL_alignments.txt")
entbic7R<- read_tsv("2A/EntB_2Apro/assimetrical trimming/PSSMsearch_2apro_7wR_alignments.txt")
entbic7L<- read_tsv("2A/EntB_2Apro/assimetrical trimming/PSSMsearch_2apro_7wL_alignments.txt")
entbic6R<- read_tsv("2A/EntB_2Apro/assimetrical trimming/PSSMsearch_2apro_6wR_alignments.txt")
entbic6L<- read_tsv("2A/EntB_2Apro/assimetrical trimming/PSSMsearch_2apro_6wL_alignments.txt")


dmsic10 <- read_tsv("2A/DMS_2Apro/assimetrical trimming/PSSMSearch_results_2apro_DMS_10aa.txt")
dmsic9R<- read_tsv("2A/DMS_2Apro/assimetrical trimming/PSSMsearch_2apro_9wR_DMS.txt")
dmsic9L<-read_tsv("2A/DMS_2Apro/assimetrical trimming/PSSMsearch_2apro_9wL_DMS.txt")
dmsic8R<- read_tsv("2A/DMS_2Apro/assimetrical trimming/PSSMsearch_2apro_8wR_DMS.txt")
dmsic8L<- read_tsv("2A/DMS_2Apro/assimetrical trimming/PSSMsearch_2apro_8wL_DMS.txt")
dmsic7R<- read_tsv("2A/DMS_2Apro/assimetrical trimming/PSSMsearch_2apro_7wR_DMS.txt")
dmsic7L<- read_tsv("2A/DMS_2Apro/assimetrical trimming/PSSMsearch_2apro_7wL_DMS.txt")
dmsic6R<- read_tsv("2A/DMS_2Apro/assimetrical trimming/PSSMsearch_2apro_6wR_DMS.txt")
dmsic6L<- read_tsv("2A/DMS_2Apro/assimetrical trimming/PSSMsearch_2apro_6wL_DMS.txt")
...
ggplot(ratplot, aes(window, rat, cant, label=Sequences)) + ggtitle("Ratio hits-background (raw)")+
  ...
  geom_text(aes(label= cant, group = Sequences),color = "white", position = position_dodge2(width = .8), show.legend = FALSE, hjust = .5,vjust=2, size = 4)+ 
  theme_minimal()
...
genes10<- dmsic10u[dmsic10u$GeneName %in% ref_val$V1,]
genes10a<-entbic10u[entbic10u$GeneName %in% ref_val$V1,]
genes9R<- dmsic9Ru[dmsic9Ru$GeneName %in% ref_val$V1,]
genes9Ra<- entbic9Ru[entbic9Ru$GeneName %in% ref_val$V1,]


sum(genes9R$GeneName %in% genes9Ra$GeneName)


write.table(both9R, file="2A/9Rcombination.txt", quote=F, sep= "\t", row.names = F)
